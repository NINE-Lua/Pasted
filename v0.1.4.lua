...
-- Instances: 42 | Scripts: 14 | Modules: 0 | Tags: 0
local G2L = {};
...
-- StarterGui.ScreenGui.PastedExecutor.SettingsLabel
...
G2L["28"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Bold, Enum.FontStyle.Italic);
G2L["28"]["TextColor3"] = Color3.fromRGB(0, 0, 0);
G2L["28"]["BackgroundTransparency"] = 1;
G2L["28"]["RichText"] = true;
G2L["28"]["Size"] = UDim2.new(0, 437, 0, 111);
G2L["28"]["Visible"] = false;
G2L["28"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["28"]["Text"] = [[Nothing here, yet...]];
G2L["28"]["Name"] = [[SettingsLabel]];
G2L["28"]["Position"] = UDim2.new(0.11503, 0, 0.3541, 0);
...
G2L["29"]["Size"] = UDim2.new(0, 48, 0, 45);
G2L["29"]["Position"] = UDim2.new(0.01642, 0, 0.81639, 0);
...
local script = G2L["27"];
	...
	local settingsLabel = panel:FindFirstChild("SettingsLabel")
	if not settingsLabel then
		warn("SettingsLabel not found!")
		return
	end
	local targets = {
